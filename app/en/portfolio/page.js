...
export const metadata = {
  title: 'Our Work',
  description: 'Browse Amvora projects in web design and development for real estate, e-commerce, and professional businesses.',
  alternates: { canonical: '/en/portfolio' },
};

export default async function PortfolioIndexEn() {
  let items = [];
  let settings = {};
  try {
    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="py-16 sm:py-20 max-w-7xl mx-auto px-4 sm:px-6">
        <div className="text-center mb-16">
          ...
          <h1 className="text-3xl sm:text-5xl font-black text-gray-900 mb-4">Our Work</h1>
          <p className="text-gray-500 max-w-xl mx-auto">A selection of projects we've designed and built for clients across industries.</p>
        </div>

        <PortfolioGrid items={items} locale="en" />
      </section>
