...
export const metadata = {
  title: 'خدماتنا',
  description: 'تصميم وبرمجة مواقع مخصصة للعقارات، المتاجر الإلكترونية، والمهن الحرة، مع تكامل بوابات الدفع وإدارة المحتوى.',
  alternates: { canonical: '/services' },
};

export default async function ServicesPage() {
  const { settings, strategicValue, specialties, processSteps, wa } = await fetchSiteContent('ar');
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <section className="relative pt-16 pb-14 sm:pt-20 sm:pb-16 overflow-hidden bg-gradient-to-b from-[#fdf9ee] to-white text-center px-4 sm:px-6">
        ...
        <h1 className="text-3xl sm:text-5xl font-black text-gray-900 mb-4 relative">خدماتنا</h1>
        <p className="text-gray-500 max-w-xl mx-auto relative">من الأبراج العقارية للعيادات الطبية والمطاعم - كل نشاط له بنية رقمية تناسبه.</p>
      </section>
      ...
      <section className="py-16 sm:py-24 max-w-7xl mx-auto px-4 sm:px-6">
        <div className="text-center mb-16">
          ...
          <h2 className="text-2xl md:text-4xl font-black text-gray-900">ليه موقعك الإلكتروني أهم استثمار في نشاطك؟</h2>
        </div>
      ...
      <section className="py-16 sm:py-20 max-w-4xl mx-auto px-4 sm:px-6 text-center">
        <div className="premium-card-bg border-2 border-gold/40 rounded-3xl p-8 sm:p-12 glow-gold">
          <h2 className="text-xl sm:text-3xl font-black text-gray-900 mb-4">مش لاقي تخصصك؟ كلمنا</h2>
          <p className="text-gray-500 mb-6">أي نشاط تجاري أو مهنة، هنقدر نبني لك موقع يناسب طبيعة شغلك بالظبط.</p>
